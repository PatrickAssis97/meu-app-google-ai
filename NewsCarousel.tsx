...
const NewsCarousel: React.FC<NewsCarouselProps> = ({ newsItems, settings }) => {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-lg shadow-2xl h-full flex flex-col p-4 relative overflow-hidden">
      ...
      <div 
        className={`flex-grow flex flex-col justify-center items-center text-center m-2 p-2 rounded-lg transition-all duration-700 border-2 ${urgentClass}`}
        style={itemStyle}
      >
